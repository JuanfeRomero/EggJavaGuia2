package Ejercicio_12.Main;

import Ejercicio_12.com.Persona.Persona;
import Ejercicio_12.com.Persona.PersonaService;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(persona.getNombre() + " tiene " + servicio.calcularEdad(persona) + " años.");
        System.out.println(persona.getNombre() + " es " + (servicio.menorQue(persona, 21)? "menor de " : "mayor de ") + "21 años");

        System.out.println(servicio.mostrarPersona(persona));
    }
}
