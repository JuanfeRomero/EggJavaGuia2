...
import Ejercicio_07.com.Persona.Persona;
import Ejercicio_07.com.Persona.PersonaService;
...
public class Main {
    public static void main(String[] args) {
        ...
        service.crearPersona(persona1);

        System.out.println(persona1);

        if(service.esMayorDeEdad(persona1)){
        ...
        switch (service.calcularIMC(persona1)){
            case MENORA20:
                System.out.println("La persona esta con muy bajo peso");
                break;
            case ENTRE20y25:
                System.out.println("La persona esta con el peso justo");
                break;
            case MAYORA25:
